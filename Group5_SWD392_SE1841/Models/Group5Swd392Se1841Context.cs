...
public partial class Group5Swd392Se1841Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__46A222CD7AA6DED2");

            entity.ToTable("Account");

            entity.HasIndex(e => e.UserName, "UQ__Account__7C9273C4055E00DB").IsUnique();
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__C2232422457616D1");

            entity.ToTable("Department");

            entity.HasIndex(e => e.DepartmentName, "UQ__Departme__226ED157204253F1").IsUnique();
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__C52E0BA82399C50E");

            entity.ToTable("Employee");

            entity.HasIndex(e => e.EmployeeEmail, "UQ__Employee__0A874BCF39EF2B3C").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.TypeName, e.TypeKey }).HasName("PK__Master__EFD3E573E9B1FD31");
        ...
        {
            entity.HasKey(e => e.ProjectId).HasName("PK__Project__BC799E1FBC163BA0");

            entity.ToTable("Project");

            entity.HasIndex(e => e.ProjectName, "UQ__Project__4A0B0D699CB85B4C").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.EmployeeId, e.ProjectId, e.StartDate }).HasName("PK__ProjectE__1E4F6428F5BD0A24");
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.ProjectEmployees)
                .HasForeignKey(d => d.EmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProjectEm__emplo__4AB81AF0");

            entity.HasOne(d => d.Project).WithMany(p => p.ProjectEmployees)
                .HasForeignKey(d => d.ProjectId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProjectEm__proje__4BAC3F29");
        });

        modelBuilder.Entity<Task>(entity =>
        {
            entity.HasKey(e => e.TaskId).HasName("PK__Task__0492148D0986FF79");

            entity.ToTable("Task");

            entity.HasIndex(e => e.TaskName, "UQ__Task__69906596DAF7FFB2").IsUnique();
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.Tasks)
                .HasForeignKey(d => d.EmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Task__employee_i__4F7CD00D");

            entity.HasOne(d => d.Project).WithMany(p => p.Tasks)
                .HasForeignKey(d => d.ProjectId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Task__project_id__5070F446");
        });

        modelBuilder.Entity<Timesheet>(entity =>
        {
            entity.HasKey(e => e.TimeSheetId).HasName("PK__Timeshee__708A743B4FDD906D");
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.Timesheets)
                .HasForeignKey(d => d.EmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Timesheet__emplo__440B1D61");
        });
